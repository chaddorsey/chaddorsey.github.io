...
const rawAttributes = [
  ...
  // Education / Youth
  { name: 'Students Graduating from High School (%)', group: 'education_youth', description: 'Percentage of students that graduate from high school in 4 years.' },
  { name: 'Some College (%)', group: 'education_youth', description: 'Percentage of people ages 25-44 with at least some education beyond high school.' },
  ...
  { name: 'Juvenile Arrest Rate', dataKey: 'Juvenile Arrest Rate (arrests/ 1,000 juveniles)', group: 'education_youth', description: 'Delinquency cases per 1,000 juveniles.' },
